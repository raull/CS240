...
public class StringTransformation {
	...
	//Insertion Transformation
		...
		public static ArrayList<String> transpositionTransformationsFromString(String word) {
			ArrayList<String> stringArrayList = new ArrayList<String>();
		...
		public static ArrayList<String> alterationTransformationsFromString(String word) {
			ArrayList<String> stringArrayList = new ArrayList<String>();
		...
		public static ArrayList<String> allTransformationsFromString(String word) {
			ArrayList<String> strArrayList = new ArrayList<String>();
			
			strArrayList.addAll(insertionTransformationsFromString(word));
			strArrayList.addAll(deletionTransformationsFromString(word));
			strArrayList.addAll(alterationTransformationsFromString(word));
			strArrayList.addAll(transpositionTransformationsFromString(word));
		...
		public static void main(String[] args) {
			...
			System.out.println("Transposition Transformation: \n" + StringTransformation.transpositionTransformationsFromString("Raul"));
			System.out.println("Alteration Transformation: \n" + StringTransformation.alterationTransformationsFromString("Raul"));
		}
}
